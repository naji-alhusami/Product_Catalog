...
const KeysHeader = () => {
  return (
    <div className="w-full xl:flex xl:flex-row xl:justify-between xl:items-center xl:gap-x-16">
      <div className="py-5 h-full max-w-6xl mx-auto text-center flex flex-col justify-between items-center xl:text-start">
        <div>
